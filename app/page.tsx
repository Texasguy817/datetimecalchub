        ...
        <section className="mx-auto max-w-6xl px-4 py-12 md:px-6">
          ...
          <section className="mt-14 rounded-3xl border border-slate-200 p-6">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              <Link className="rounded-2xl border border-slate-200 p-4 hover:bg-slate-50" href="/what-time-will-it-be-in-1-hour">What Time Will It Be in 1 Hour?</Link>
              <Link className="rounded-2xl border border-slate-200 p-4 hover:bg-slate-50" href="/what-time-will-it-be-in-5-hours">What Time Will It Be in 5 Hours?</Link>
              <Link className="rounded-2xl border border-slate-200 p-4 hover:bg-slate-50" href="/what-time-will-it-be-in-10-hours">What Time Will It Be in 10 Hours?</Link>
              ...
              <Link className="rounded-2xl border border-slate-200 p-4 hover:bg-slate-50" href="/add-10-days-to-date">Add 10 Days to a Date</Link>
            </div>
          </section>
